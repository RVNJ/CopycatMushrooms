...
public class EmpoweredBiohazard extends Actor {
	...
	static private final int COST = 10000;
	...
	public void drawHitpointsBar(Graphics g) {
		...
		if (immunityTimer <= 0 && damageReductionTimer <= 0) {
			...
			g.drawRect((int) pos.getX() - 20, (int) pos.getY() - 10, (int) (box.getX() + 30), 4);
			g.setColor(new Color(255, 40, 40));
			g.fillRect((int) pos.getX() - 19, (int) pos.getY() - 9, (int) ((box.getX() + 29) * ((double) this.hitpoints / (double) this.maximumHitpoints)), 3);
		} else {
			g.setColor(Color.BLACK);
			g.drawRect((int) pos.getX() - 20, (int) pos.getY() - 14, (int) (box.getX() + 30), 4);
			g.setColor(new Color(255, 40, 40));
			g.fillRect((int) pos.getX() - 19, (int) pos.getY() - 13, (int) ((box.getX() + 29) * ((double) this.hitpoints / (double) this.maximumHitpoints)), 3);
		}
	}
	...
	public void drawLifespanBar(Graphics g) {
		...
		if (this.immunityTimer > 0) {
			...
			g.fillRect((int) pos.getX() - 19, (int) pos.getY() - 9, (int) ((box.getX() + 29) * ((double) this.immunityTimer / (double) this.immunityDuration)), 3);
		} else {
			if (this.damageReductionTimer > 0) {
				g.setColor(Color.BLACK);
				g.drawRect((int) pos.getX() - 20, (int) pos.getY() - 10, (int) box.getX() + 30, 4);
				g.setColor(new Color(255, 128, 40));
				g.fillRect((int) pos.getX() - 19, (int) pos.getY() - 9, (int) ((box.getX() + 29) * ((double) this.damageReductionTimer / (double) this.damageReductionDuration)), 3);
			}
		}
	}
	...
	public void drawMaximumEffectBar(Graphics g) {
		...
		Point2D.Double box = this.getHitbox();
		g.setColor(Color.BLACK);
		g.drawRect((int) pos.getX() - 20, (int) pos.getY() - 6, (int) (box.getX() + 30), 4);
		g.setColor(new Color(255, 255, 40));
		g.fillRect((int) pos.getX() - 19, (int) pos.getY() - 5, (int) ((box.getX() + 29) * ((double) this.attackPower / (double) this.attackPowerCap)), 3);
	}
